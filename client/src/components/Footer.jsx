    ...
    return (
        <div className='bg-slate-900 mt-10 py-6'>
            <div className='px-5 flex flex-col justify-evenly items-center lg:px-32 lg:flex-row'>
                ...
                <div>
                    <button className="bg-orange-600 text-white text-sm font-semibold py-3 rounded-xl m-2 transition duration-200 ease-in-out hover:bg-orange-700">Connect with us</button>
                </div>
            </div>
        </div>
    )
